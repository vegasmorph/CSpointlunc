    ...
    return ( 
      <div className="coin"> 
        ...
        <div className="TSupply"> 
          <h3>Total Supply ------------------------------- {(TotalSupply).toLocaleString('pt-br', {minimumFractionDigits: 2})} LUNC</h3> 
        </div> 
   
        <div className="CSupply"> 
          <h3> Circ. Supply -------------------------------- {((TotalSupply)-(Staking/1000000)).toLocaleString('pt-br', {minimumFractionDigits: 2})} LUNC</h3> 
        </div> 
